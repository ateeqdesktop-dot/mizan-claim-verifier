...
بعد مقارنة ثماني أفكار وفق القيمة العملية، العمق التقني، الأصالة، قابلية التنفيذ، وقوة العرض في Portfolio، حصل مشروع التحقق العربي القائم على الأدلة على أعلى نتيجة موزونة: **97/100**. يتجاوز المشروع تكرار كاشف الأخبار الزائفة الثنائي بإضافة الاسترجاع، التفسير، عتبة الامتناع، ومنهجية تقييم تمنع تسرب المقالات بين التدريب والاختبار. يلخص الجدول التالي أعلى المرشحين، وتعرض وثيقة [مقارنة الأفكار الكاملة](docs/idea_comparison.md) تفاصيل كل فكرة ومصدر بياناتها وتقدير صعوبتها وزمنها. كما يشرح [تحليل الفجوات](docs/gap_analysis.md) كيف تحولت متطلبات النسخة الاحترافية إلى تغييرات قابلة للفحص.
...
| `docs/project_decision.md` | قرار اختيار الفكرة ونطاق الإصدار المحسن |
| `docs/gap_analysis.md` | تدقيق الفجوات ومعايير قبول النسخة المحسنة |
| `docs/idea_comparison.md` | مقارنة ثماني أفكار، مصادر البيانات، الأوزان، والقرار النهائي |
| `docs/research_audit_notes.md` | تدقيق خارجي لمصدري AraFacts وAuRED وأثرهما على النطاق |
...
أُعيد التحقق من مصدرَي AraFacts وAuRED الأكاديميين قبل تثبيت هذا النطاق؛ توضح [`مذكرة تدقيق البحث`](docs/research_audit_notes.md) سبب استخدام AraFacts للتدريب وحفظ AuRED لاختبار خارجي منفصل.
