...
بعد مقارنة ثماني أفكار وفق القيمة العملية، العمق التقني، الأصالة، قابلية التنفيذ، وقوة العرض في Portfolio، حصل مشروع التحقق العربي القائم على الأدلة على أعلى نتيجة موزونة: **97/100**. يتجاوز المشروع تكرار كاشف الأخبار الزائفة الثنائي بإضافة الاسترجاع، التفسير، عتبة الامتناع، ومنهجية تقييم تمنع تسرب المقالات بين التدريب والاختبار. يلخص الجدول التالي أعلى المرشحين، وتعرض وثيقة [مقارنة الأفكار الكاملة](docs/idea_comparison.md) تفاصيل كل فكرة ومصدر بياناتها وتقدير صعوبتها وزمنها.
